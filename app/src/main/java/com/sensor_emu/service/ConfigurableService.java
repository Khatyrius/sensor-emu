...
public class ConfigurableService {
    ...
    public List<EnergyFrequency> getEnergyFrequencyListByTimestamp(final long timestampStart,
            final long timestampEnd) {
        return energyFrequencyDao.getByTimestamp(timestampStart, timestampEnd);
    }

    public long getEnergyFrequencyFirstTimestamp() {
        return energyFrequencyDao.getFirstTimestamp();
    }

    public long getEnergyFrequencyLastTimestamp() {
        return energyFrequencyDao.getLastTimestamp();
    }
    ...
    public List<HumidityFrequency> getHumidityFrequencyListByTimestamp(final long timestampStart,
            final long timestampEnd) {
        return humidityFrequencyDao.getByTimestamp(timestampStart, timestampEnd);
    }

    public long getHumidityFrequencyFirstTimestamp() {
        return humidityFrequencyDao.getFirstTimestamp();
    }

    public long getHumidityFrequencyLastTimestamp() {
        return humidityFrequencyDao.getLastTimestamp();
    }
    ...
    public List<PressureFrequency> getPressureFrequencyListByTimestamp(final long timestampStart,
            final long timestampEnd) {
        return pressureFrequencyDao.getByTimestamp(timestampStart, timestampEnd);
    }

    public long getPressureFrequencyFirstTimestamp() {
        return pressureFrequencyDao.getFirstTimestamp();
    }

    public long getPressureFrequencyLastTimestamp() {
        return pressureFrequencyDao.getLastTimestamp();
    }
    ...
    public List<TemperatureFrequency> getTemperatureFrequencyListByTimestamp(
            final long timestampStart, final long timestampEnd) {
        return temperatureFrequencyDao.getByTimestamp(timestampStart, timestampEnd);
    }

    public long getTemperatureFrequencyFirstTimestamp() {
        return temperatureFrequencyDao.getFirstTimestamp();
    }

    public long getTemperatureFrequencyLastTimestamp() {
        return temperatureFrequencyDao.getLastTimestamp();
    }

    public void deleteEnergyFrequencyByTimestamp(final long timestampStart,
            final long timestampEnd) {
        final List<EnergyFrequency> list = energyFrequencyDao
                .getByTimestamp(timestampStart, timestampEnd);
        final EnergyFrequency energyFrequency = energyFrequencyDao.getByHighestId();
        if (list != null) {
            if (list.contains(energyFrequency)) {
                energyFrequencyDao.deleteByTimestampAndId(timestampStart, timestampEnd,
                        energyFrequency.getId());
            } else {
    ...
    public void deleteHumidityFrequencyByTimestamp(final long timestampStart,
            final long timestampEnd) {
        final List<HumidityFrequency> list = humidityFrequencyDao
                .getByTimestamp(timestampStart, timestampEnd);
        final HumidityFrequency humidityFrequency = humidityFrequencyDao.getByHighestId();
        if (list != null) {
            if (list.contains(humidityFrequency)) {
                humidityFrequencyDao.deleteByTimestampAndId(timestampStart, timestampEnd,
                        humidityFrequency.getId());
            } else {
    ...
    public void deletePressureFrequencyByTimestamp(final long timestampStart,
            final long timestampEnd) {
        final List<PressureFrequency> list = pressureFrequencyDao
                .getByTimestamp(timestampStart, timestampEnd);
        final PressureFrequency pressureFrequency = pressureFrequencyDao.getByHighestId();
        if (list != null) {
            if (list.contains(pressureFrequency)) {
                pressureFrequencyDao.deleteByTimestampAndId(timestampStart, timestampEnd,
                        pressureFrequency.getId());
            } else {
    ...
    public void deleteTemperatureFrequencyByTimestamp(final long timestampStart,
            final long timestampEnd) {
        final List<TemperatureFrequency> list = temperatureFrequencyDao
                .getByTimestamp(timestampStart, timestampEnd);
        ...
        if (list != null) {
            if (list.contains(temperatureFrequency)) {
                temperatureFrequencyDao.deleteByTimestampAndId(timestampStart, timestampEnd,
                        temperatureFrequency.getId());
            } else {
    ...
    public List<Class<? extends AbstractConfigurableEntity>> getClassList() {
        return Arrays.asList(EnergyFrequency.class, HumidityFrequency.class,
                PressureFrequency.class, TemperatureFrequency.class);
    }
}
