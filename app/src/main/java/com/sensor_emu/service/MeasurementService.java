...
public class MeasurementService {
    ...
    public List<Temperature> getTemperatureListByTimestamp(final long timestampStart, final long timestampEnd) {
    ...
    public List<Humidity> getHumidityListByTimestamp(final long timestampStart, final long timestampEnd) {
    ...
    public List<Pressure> getPressureListByTimestamp(final long timestampStart, final long timestampEnd) {
    ...
    public List<Energy> getEnergyListByTimestamp(final long timestampStart, final long timestampEnd) {
